 ...
 * @version: 
 * @Author: Lone
 * @Date: 2022-05-01 14:32:03
 * @LastEditors: Lone
 * @LastEditTime: 2022-05-04 14:23:34
-->
<template>
            ...
            <a-timeline-item v-for="(item, index) in list" :key="index">
                    ...
                    <div class="time-line-item">
                        <div class="time_line_left">
                            ...
                            <div class="time_user">
                                ...
                                <a-icon type="user" />
                                <div class="user">
                                    {{ item.data.activityParticipants[0] && item.data.activityParticipants[0].customerName }}
                                </div>
                            </div>
                            <div class="content">
                ...
                <div
                    ...
                    <div class="time_line_left">
                        ...
                        >
                            <!-- <div>{{ item.timestamp.substring(0, 10) }}</div> -->
                            <div>{{ item.timestamp | filterTime(item.timestamp) }} · {{item.data.createUserName}}</div>
                            <div class="business">
                                <div v-html="'名稱：' + item.data.title" style="margin-left:5px;"></div>
                                <div v-html="'金額：' +item.data.money" style="margin-left:5px;"></div>
                                <div v-html="'階段：' + item.data.salesStageName" style="margin-left:5px;"></div>
                                <div v-html="'流程：' + item.data.salesFlowName" style="margin-left:5px;"></div>
                            </div>
                        </template>
